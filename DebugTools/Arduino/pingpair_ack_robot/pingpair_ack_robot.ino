...
// Topology
const uint64_t pipes[1] = { 0xE7E7E7E7E7LL };              // Radio pipe addresses for the 2 nodes to communicate.
...
void setup(){
  ...
  //radio.openWritingPipe(0x25);        // Both radios listen on the same pipes by default, and switch when writing
